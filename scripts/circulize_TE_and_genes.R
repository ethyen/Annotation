...
lgd=Legend(title = "Superfamily",  at = c("Genes","Gypsy_LTR_retrotransposon", "Copia_LTR_retrotransposon","L1_LINE_retrotransposon","SINE_element","CACTA_TIR_transposon","Mutator_TIR_transposon","PIF_Harbinger_TIR_transposon","Tc1_Mariner_TIR_transposon","hAT_TIR_transposon","helitron"), 
           legend_gp = gpar(fill = c("black","darkgreen", "darkred","blue","yellow","orchid","palevioletred","mediumpurple1","maroon","purple1","orange2")))
